...
static const char *object_names[] = { "main", "settings", "settings_panel", "settings_switch_panel", "save_back", "back", "background", "banner_alert", "banner_alert_text", "front_left_container", "fl_portal_guage", "fl_portal_label", "front_right_container", "fr_portal_guage", "fr_portal_label", "rear_left_container", "rl_portal_guage", "rl_portal_label", "rear_right_container", "rr_portal_guage", "rr_portal_label", "my_horizontal_slider", "my_panel_header_1", "obj0", "alarm_switch", "alarm_switch_label", "setting_label_alarm", "max_temp_slider", "max_temp_slider_label", "max_diff_slider", "max_diff_slider_label", "max_temp", "max_diff" };
